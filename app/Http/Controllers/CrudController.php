    ...
    public function listData(Request $request)
    {
        ...
        return $datatables
                ...
                ->addColumn('aksi', function ($data) {
                    $aksi = "";
                    $aksi .= "<a title='Edit Data' href='/anggota_keluarga/".$data->id."/edit' class='btn btn-md btn-primary' data-toggle='tooltip' data-placement='bottom' onclick='buttonsmdisable(this)'><i class='ti-pencil' ></i></a>";
