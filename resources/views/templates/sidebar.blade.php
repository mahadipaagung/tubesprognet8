    ...
    <div class="nk-sidebar-element nk-sidebar-head">
        ...
        <div class="nk-sidebar-brand">
            <a href="html/index.html" class="logo-link nk-sidebar-logo">
                <img class="logo-light logo-img" src="{{ asset('assets/images/leaf-branch-logo.png') }}"
                    srcset="{{ asset('assets/images/leaf-branch-logo.png') }}" alt="logo">
                <img class="logo-dark logo-img" src="{{ asset('assets/images/leaf-branch-logo.png') }}"
                    srcset="{{ asset('assets/images/leaf-branch-logo.png') }}" alt="logo-dark">
            </a>
        </div>
        ...
        <div class="nk-sidebar-content">
            <div class="nk-sidebar-menu" data-simplebar>
                <ul class="nk-menu">
                    ...
                    <li class="nk-menu-item">
                        <a href="{{ route('pegawai.index') }}" class="nk-menu-link">
                            <span class="nk-menu-icon"><em class="icon ni ni-layers-fill"></em></span>
                            <span class="nk-menu-text">Pegawai</span>
                        </a>
                    </li><!-- .nk-menu-item -->
                    {{-- <li class="nk-menu-item">
                        <a href="{{ route('anggota_keluarga.index') }}" class="nk-menu-link">
                            <span class="nk-menu-icon"><em class="icon ni ni-linux-server"></em></span>
                            <span class="nk-menu-text">Riwayat Struktural</span>
                        </a>
                    </li><!-- .nk-menu-item -->
                    <li class="nk-menu-item">
                        <a href="{{ URL('/crud4') }}" class="nk-menu-link">
                            <span class="nk-menu-icon"><em class="icon ni ni-coins"></em></span>
                            <span class="nk-menu-text">Riwayat Keaftifan</span>
                        </a>
                    </li><!-- .nk-menu-item --> --}}
                    <li class="nk-menu-heading">
