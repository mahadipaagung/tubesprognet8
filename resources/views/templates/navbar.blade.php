    ...
    <div class="nk-header-wrap">
        ...
        <div class="nk-header-brand d-xl-none">
            <a href="{{ URL('/') }}" class="logo-link">
                ...
                <img class="logo-light logo-img" src="{{ asset('assets/images/logo-balimed.png') }}"
                    srcset="{{ asset('assets/images/logo-balimed.png') }}" alt="logo">
                <img class="logo-dark logo-img" src="{{ asset('assets/images/logo-balimed.png') }}"
                    srcset="{{ asset('assets/images/logo-balimed.png') }}" alt="logo-dark">
            </a>
        </div><!-- .nk-header-brand -->
                ...
                <li class="dropdown user-dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-md dropdown-menu-right dropdown-menu-s1 is-light">
                        <div class="dropdown-inner user-account-info">
                            <center>
                                <h6 class="overline-title-alt"> Selamat Datang {{ auth()->user()->name }}</h6>
                                <div class="div">
