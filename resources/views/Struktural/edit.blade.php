    ...
    <div class="nk-fmg-quick-list nk-block">
        <div class="card">
            <div class="card-body">
                ...
                <form method="POST" action="{{ route('struktural.update', $data->riwayat_struktural_id) }}" id='form1'
                            ...
                            <div class="form-group">
                                ...
                                <select name="jabatan_struktural_id" id="jabatan_struktural_id" class="form-control"
                                    ...
                                    <option value="{{ $data->jabatan_struktural_id }}">
                                        {{ $data->jabatan->nama_jabatan_singkat }}</option>
                                    @foreach ($jabatan as $id => $name)
                                        <option value="{{ $name->id }}">{{ $name->nama_jabatan_singkat }}</option>
                                    @endforeach
                                </select>
                        ...
                        <div class="col-md">
                            <div class="form-group">
                                ...
                                <select name="sub_unit_id" id="sub_unit_id" class="form-control" autofocus>
                                    <option value="{{ $data->sub_unit_id }}">{{ $data->sub_unit->nama_subunit }}
                                    </option>
                        ...
                        <div class="col-md">
                            <div class="form-group">
                                ...
                                <input type="text"
                                    ...
                                    value="{{ old('jabatan_penanda_tangan_berhenti', $data->jabatan_penanda_tangan_berhenti ?? null) }}">
