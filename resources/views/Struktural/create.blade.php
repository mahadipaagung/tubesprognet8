    ...
    <div class="nk-fmg-body-head d-none d-lg-flex">
        ...
        <div class="nk-fmg-actions">
            <div class="btn-group">
                ...
                <a href="pegawai/struktural/{{ $id }}" class="btn btn-sm btn-primary"
                            ...
                            <div class="form-group">
                                ...
                                <select name="jabatan_struktural_id" id="jabatan_struktural_id" class="form-control"
                                    ...
                                    @foreach ($jabatan as $id => $name)
                                        <option value="{{ $name->jabatan_id }}">{{ $name->nama_jabatan_singkat }}</option>
                                    @endforeach
                                </select>
                        ...
                        <div class="col-md">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('no_sk_diangkat') is-invalid @enderror"
                                    name="no_sk_diangkat" required autofocus value="{{ old('no_sk_diangkat') }}">
                        ...
                        <div class="col-md">
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control @error('tmt_sk_diangkat') is-invalid @enderror"
                                    name="tmt_sk_diangkat" required autofocus value="{{ old('tmt_sk_diangkat') }}">
                        ...
                        <div class="col-md">
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control @error('tgl_sk_diangkat') is-invalid @enderror"
                                    name="tgl_sk_diangkat" required autofocus value="{{ old('tgl_sk_diangkat') }}">
                        ...
                        <div class="col-md">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('no_sk_berhenti') is-invalid @enderror"
                                    name="no_sk_berhenti" required autofocus value="{{ old('no_sk_berhenti') }}">
                        ...
                        <div class="col-md">
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control @error('tmt_sk_berhenti') is-invalid @enderror"
                                    name="tmt_sk_berhenti" required autofocus value="{{ old('tmt_sk_berhenti') }}">
                        ...
                        <div class="col-md">
                            <div class="form-group">
                                ...
                                <input type="date"
                                    ...
                                    name="tanggal_sk_berhenti" required autofocus
                                    value="{{ old('tanggal_sk_berhenti') }}">
                                @error('tanggal_sk_berhenti')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                                @enderror
                        ...
                        <div class="col-md">
                            <div class="form-group">
                                ...
                                <input type="date"
                                    ...
                                    name="tanggal_sk_berakhir" required autofocus
                                    value="{{ old('tanggal_sk_berakhir') }}">
                                @error('tanggal_sk_berakhir')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                                @enderror
                        ...
                        <div class="col-md">
                            <div class="form-group">
                                ...
                                <input type="text"
                                    ...
                                    value="{{ old('nama_penanda_tangan_pengangkat') }}">
                        ...
                        <div class="col-md">
                            <div class="form-group">
                                ...
                                <input type="text"
                                    ...
                                    value="{{ old('jabatan_penanda_tangan_pengangkat') }}">
                        ...
                        <div class="col-md">
                            <div class="form-group">
                                ...
                                <input type="text"
                                    ...
                                    value="{{ old('nama_penanda_tangan_berhenti') }}">
                        ...
                        <div class="col-md">
                            <div class="form-group">
                                ...
                                <input type="text"
                                    ...
                                    value="{{ old('jabatan_penanda_tangan_berhenti') }}">
                    ...
                    <div class="row mb-3">
                        <div class="col-md">
                            <div class="form-group">
                                ...
                                <input type="file" class="form-control" name="file_sk_diangkat">
