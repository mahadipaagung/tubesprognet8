    ...
    <div class="nk-fmg-body-head d-none d-lg-flex">
        ...
        <div class="nk-fmg-actions">
            <div class="btn-group">
                ...
                <a href="pegawai/keluarga/{{ $id }}" class="btn btn-sm btn-primary"
                            ...
                            <div class="form-group">
                                ...
                                <select name="pekerjaan_id" id="pekerjaan_id" class="form-control" autofocus>
                                    @foreach ($pekerjaan as $id => $name)
                                        <option value="{{ $name->id }}">{{ $name->pekerjaan }}</option>
                                    @endforeach
                                </select>
                                @error('pekerjaan_id')
                                    <div class="invalid-feedback">
                        ...
                        <div class="col-md">
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control @error('tanggal_lahir') is-invalid @enderror"
                                    name="tanggal_lahir" required autofocus value="{{ old('tanggal_lahir') }}">
                                @error('tanggal_lahir')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                        ...
                        <div class="col-md">
                            <div class="form-group">
                                ...
                                <textarea name="alamat" id="" cols="30" rows="10"
                                    class="form-control @error('alamat') is-invalid @enderror" required autofocus>{{ old('alamat') }}</textarea>
                                @error('alamat')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                        ...
                        <div class="col-md">
                            <div class="form-group">
                                ...
                                <select name="golongan_darah_id" id="golongan_darah" class="form-control" autofocus>
                                    @foreach ($golongan_darah as $id => $name)
                                        <option value="{{ $name->id }}">{{ $name->nama }}</option>
                                    @endforeach
                                </select>
                        ...
                        <div class="col-md">
                            <div class="form-group">
                                ...
                                <textarea name="keterangan" id="" cols="30" rows="10"
                                    class="form-control @error('keterangan') @enderror" required autofocus>{{ old('keterangan') }}</textarea>
                                @error('keterangan')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                        ...
                        <div class="col-md">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('akta_meninggal') is-invalid @enderror"
                                    name="akta_meninggal" required autofocus value="{{ old('akta_meninggal') }}">
                    ...
                    <div class="row mb-3">
                        <div class="col-md">
                            <div class="form-group">
                                ...
                                <input type="file" class="form-control" name="file_akta_meninggal">
                        ...
                        <div class="col-md">
                            <div class="form-group">
                                ...
                                <input type="date"
                                    ...
                                    name="tgl_meninggal" required autofocus value="{{ old('tanggal_meninggal') }}">
                                @error('tgl_meninggal')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
